        ...
        <div className="form-inner">
          <div className="from-control py-4">
            ...
            <input
              ...
              name="name"
              id="taskName"
              className="block w-[100%] p-1 border rounded outline-none focus:border-black"
              value={taskName}
          ...
          <div className="form-control flex justify-end">
            <input
              type="submit"
              value="Add Task"
              className="bg-blue-500 hover:bg-blue-600 cursor-pointer text-white font-bold py-2 px-4 rounded transition w-[300px]"
              onClick={handleEvent}
            />
          </div>
        </div>
